    ...
    try {
      ...
      const res = await fetch('/api/habits', {
        ...
        body: JSON.stringify({
          ...
          color,
          type,
          goal_mode: type === 'binary' ? null : goalMode,
          goal_value: type === 'binary' ? null : parseFloat(goalValue) || null,
          goal_unit: type === 'binary' ? null : goalUnit.trim(),
          schedule_type: scheduleType,
          schedule_days: scheduleType === 'weekly' ? scheduleDays : null,
          frequency_target: scheduleType === 'frequency' ? frequencyTarget : null,
          reminder_enabled: reminderEnabled ? 1 : 0,
          reminder_time: reminderTime,
          version: 1,
          version_start_date: today,
        }),
      })
        ...
        {steps.map((s, i) => (
          <div
            ...
            className={`h-1 flex-1 rounded-full ${
              i <= stepIndex ? 'bg-[#185FA5]' : 'bg-gray-100'
            }`}
          />
        ))}
      </div>
        ...
        {step === 'type' && (
          <div>
            ...
            <div className="space-y-3 mb-5">
              {[
                { key: 'binary', label: 'Binary', description: 'Done / not done (e.g., Exercise)' },
              ...
              <div>
                ...
                <div className="mb-4">
                  ...
                  <input
                    ...
                    placeholder="e.g., glasses, pages, kg"
                    className="w-full border border-[#E5E5E5] rounded-lg px-3 py-2.5 text-sm focus:outline-none focus:border-[#185FA5]"
                  />
                </div>
              </div>
